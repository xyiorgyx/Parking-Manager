...
const Signup = () => {
  ...
  return (
    <main style={{ backgroundImage: `url(${background})` }} className="h-screen bg-gray-50 w-full dark:bg-gray-900 bg-cover bg-center">
      <div className="flex flex-col items-center justify-center px-6 py-8  md:h-screen lg:py-0">
        <div className=" w-full bg-white dark:shadow-white dark:border dark:border-white border-2 rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
