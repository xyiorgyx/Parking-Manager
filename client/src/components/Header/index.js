...
const Header = () => {
  ...
  return (
    <header className="flex-row bg-info bg-gray-700 dark:bg-gray-700 text-dark  p-3 display-flex align-center">
        ...
        <div className='align-right'>
          {Auth.loggedIn() ? (
              <button className="btn btn-lg btn-light m-2 align-right" onClick={logout}>
                Logout
              </button>
          ) : (
            <div></div>
